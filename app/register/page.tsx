...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.farmerType)
      newErrors.farmerType = "Please select farmer type";
      ...
      <Card className="w-full max-w-md border-green-100">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Enter your information to create a KrishiVaani account
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange("farmerType", value)
                }
              >
                <SelectTrigger
                  id="farmer-type"
                  ...
                  aria-describedby={
                    errors.farmerType ? "farmerType-error" : undefined
                  }
                >
